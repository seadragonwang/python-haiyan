                    ...
                    for col in columns:
                        if '/' in col:
                            ...
                            if cols[0] and cols[1]:
                                row.append(float(data[key][cols[0]]) / float(data2[key][cols[1]]))
                            elif cols[0]:
                                row.append(data[key][cols[0]])

                            elif cols[1]:
                                row.append(data2[key][cols[1]])
            ...
            for key in data.keys():
                ...
                for col in columns:
                    if col.contains('/'):
                        cols = col.split('/')
                        if cols[0] and cols[1]:
                            row.append(float(data[key][cols[0]])/float(data[key][cols[1]]))
                        elif cols[0]:
                            row.append(data[key][cols[0]])

                        elif cols[1]:
                            row.append(data[key][cols[1]])
